...
OXE_DATASET_CONFIGS = {
    ...
    "custom_ur5_none_proprio": {
        "image_obs_keys": {"primary": "image", "secondary": None, "wrist": None},
        "depth_obs_keys": {"primary": None, "secondary": None, "wrist": None},
        "proprio_encoding": ProprioEncoding.NONE,   # No proprioceptive data
        "action_encoding": ActionEncoding.EEF_POS,
    },
    "custom_ur5_euler_proprio": {
        "image_obs_keys": {"primary": "image", "secondary": None, "wrist": None},
        "depth_obs_keys": {"primary": None, "secondary": None, "wrist": None},
        "proprio_encoding": ProprioEncoding.POS_EULER,  # EEF XYZ + roll-pitch-yaw + gripper open/close
        "action_encoding": ActionEncoding.EEF_POS,
    },
    "custom_ur5_joint_proprio": {
        "image_obs_keys": {"primary": "image", "secondary": None, "wrist": None},
        "depth_obs_keys": {"primary": None, "secondary": None, "wrist": None},
        "proprio_encoding": ProprioEncoding.JOINT,  # joint angles + gripper open/close
        "action_encoding": ActionEncoding.EEF_POS,
    },
    "toto": {
        "image_obs_keys": {"primary": "image", "secondary": None, "wrist": None},
